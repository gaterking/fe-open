!function(e) {
    ...
    var u = n(14)
      , d = n(8);
    window.OFO_ENV = i,
    window.ofoResponseProxy = o.ofoResponseProxy,
    window.ofoHandleDeepLink = o.handleLink,
    window.sendDebug = a,
    window.getOfoToken = s,
    window.tip = c,
    window.saTrackCompat = r,
    window.Cookies = d,
...
, function(e, t, n) {
    ...
    var r = n(2)
      ...
      , a = function(e, t, n) {
        var a = {};
        a[t] = n,
        o.ofoAppVersionGte("1.8.8", 11850) ? i.ofoResponseProxy("trackEvent", [e, t, n]) : (a.Source = o.sourceForSa,
    ...
    ,
    c.ofoTrack = function(e, t, n, r, o, i, s) {
        var a = new XMLHttpRequest;
        a.open("GET", "//supportda.ofo.so/" + e + "?action=" + t + "&type=" + n + "&channel=" + r + "&flag=" + o + "&cid=" + i + "&subType=" + s),
        a.onload = function() {
            console.log("XHR response", a.status, a.responseText)
        }
        ,
        a.onerror = function() {}
        ,
    ...
    o.currentEnv === o.ENV.WEBAPP_ITSELF ? window.alert("bridgedSensorAnalytics used improperly!") : o.currentEnv === o.ENV.INSIDE_NEW_IOS_APP || o.currentEnv === o.ENV.INSIDE_NEW_ANDROID_APP ? r.getAppStatus(function(e) {
        r.identify(e.distinct_id),
        Object.keys(e).filter(function(e) {
            return "distinct_id" !== e
        }).forEach(function(t) {
            s[t] = e[t]
        }),
        console.log("Initialized app_info with (app) ", s),
        r.quick("autoTrack")
    }) : o.currentEnv === o.ENV.INSIDE_WEBAPP && (s = o.iframingAncestorWhichIsWebApp.getSaInfoForFrameContent(),
    console.log("Initialized app_info with (web) ", s),
    r.quick("autoTrack")),
    e.exports = c
}
, function(e, t, n) {
    e.exports = function(e) {
        var t = e.name;
        return window.sensorsDataAnalytic201505 = t,
        window[t] = {
            _q: [],
            para: e
        },
    ...
    try {
        !function(sd) {
            function app_js_bridge() {
                function e(e) {
                    r = e,
                    _.isJSONString(r) && (r = JSON.parse(r)),
                    o && o(r)
                }
                function t() {
                    "object" == typeof window.SensorsData_APP_JS_Bridge && window.SensorsData_APP_JS_Bridge.sensorsdata_call_app && (r = SensorsData_APP_JS_Bridge.sensorsdata_call_app(),
                    _.isJSONString(r) && (r = JSON.parse(r)))
                }
                function n() {
            ...
            for (var i in sd.para_default)
                void 0 === sd.para[i] && (sd.para[i] = sd.para_default[i]);
            ...
            !function() {
                ...
                function s(r, o, i) {
                    ...
                    if ("[object String]" === u) {
                        ...
                        if (t(s))
                            return s.hasOwnProperty("version") && (a.version = s.version),
                            a;
                        if (s.exec) {
                            var d = s.exec(i);
                            if (d)
                                return d.length >= 2 && d[1] ? a.version = d[1].replace(/_/g, ".") : a.version = c,
                                a
                        }
                    }
                }
                ...
                var c = "-1"
                  ...
                  , y = [["edge", /edge\/([0-9.]+)/], ["sogou", function(e) {
                    ...
                    try {
                        if (d && (d.mxVersion || d.max_version))
                            return {
            ...
            ,
            function() {
                var e = (FuncProto.bind,
                ArrayProto.forEach)
                  , t = ArrayProto.indexOf
                  , n = Array.isArray
                  , r = {}
                  , o = _.each = function(t, n, o) {
                    if (null == t)
                        return !1;
                    if (e && t.forEach === e)
                        t.forEach(n, o);
                        ...
                        for (var i = 0, s = t.length; s > i; i++)
                            if (i in t && n.call(o, t[i], i, t) === r)
                                return !1
                    } else
                        for (var a in t)
                            if (hasOwnProperty.call(t, a) && n.call(o, t[a], a, t) === r)
                                return !1
                }
                ;
                _.logger = logger,
                ...
                _.extend2Lev = function(e) {
                    return o(slice.call(arguments, 1), function(t) {
                        for (var n in t)
                            void 0 !== t[n] && (_.isObject(t[n]) && _.isObject(e[n]) ? _.extend(e[n], t[n]) : e[n] = t[n])
                    }),
                    e
                }
                ,
            ...
            _.formatString = function(e) {
                return e.length > sd.para.max_string_length ? (logger.info("字符串长度超过限制，已经做截取--" + e),
                e.slice(0, sd.para.max_string_length)) : e
            }
            ,
            ...
            _.utf8Encode = function(e) {
                ...
                r = 0; i > r; r++) {
                    var s = e.charCodeAt(r)
                      , a = null;
                    128 > s ? n++ : a = s > 127 && 2048 > s ? String.fromCharCode(s >> 6 | 192, 63 & s | 128) : String.fromCharCode(s >> 12 | 224, s >> 6 & 63 | 128, 63 & s | 128),
            ...
            _.base64Encode = function(e) {
                var t, n, r, o, i, s, a, c, u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", d = 0, l = 0, p = "", f = [];
                if (!e)
                    return e;
                e = _.utf8Encode(e);
                do
                    ...
                    s = c >> 6 & 63,
                    a = 63 & c,
                    f[l++] = u.charAt(o) + u.charAt(i) + u.charAt(s) + u.charAt(a);
                while (d < e.length);switch (p = f.join(""),
                e.length % 3) {
                case 1:
                    p = p.slice(0, -2) + "==";
                    break;
            ...
            _.UUID = function() {
                ...
                return function() {
                    ...
                    var o = e() + "-" + t() + "-" + n() + "-" + r + "-" + e();
                    return o ? (just_test_distinctid_2 = 1,
                    o) : (just_test_distinctid_2 = 2,
            ...
            _.urlParse = function(e) {
                ...
                t.prototype._parse = function(e) {
                    ...
                    for (var n in this._fields)
                        "undefined" != typeof t[this._fields[n]] && (this._values[n] = t[this._fields[n]]);
            ...
            _.cookie = {
                ...
                set: function(e, t, n, r, o) {
                    ...
                    if (0 !== n) {
                        var d = new Date;
                        "s" === String(n).slice(-1) ? d.setTime(d.getTime() + 1e3 * Number(String(n).slice(0, -1))) : d.setTime(d.getTime() + 24 * n * 60 * 60 * 1e3),
                        s = "; expires=" + d.toGMTString()
                    }
                    o && (a = "; secure"),
                    document.cookie = e + "=" + encodeURIComponent(t) + s + "; path=/" + i + a
                },
                remove: function(e, t) {
            ...
            _.localStorage = {
                ...
                isSupport: function() {
                    ...
                    try {
                        ...
                        _.localStorage.set(t, n),
                        _.localStorage.get(t) !== n && (e = !1),
            ...
            _.ajax = function(e) {
                ...
                n.onreadystatechange = function() {
                    4 == n.readyState && (n.status >= 200 && n.status < 300 || 304 == n.status ? e.success(t(n.responseText)) : e.error(t(n.responseText), n.status),
                ...
                try {
                    if (n.withCredentials = !0,
                    _.isObject(e.header))
                        for (var r in e.header)
                            n.setRequestHeader(r, e.header[r]);
                    e.data && (n.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
                    "application/json" === e.contentType ? n.setRequestHeader("Content-type", "application/json; charset=UTF-8") : n.setRequestHeader("Content-type", "application/x-www-form-urlencoded"))
                } catch (e) {}
                n.send(e.data || null)
            }
            ,
            _.url = function() {
                ...
                function n(e, t) {
                    ...
                    r[0 > e ? r.length + e : e - 1])
                }
                function r(e, n) {
                    for (var r = e.charAt(0), o = n.split("&"), i = [], s = {}, a = [], c = e.substring(1), u = 0, d = o.length; d > u; u++)
                        if (i = o[u].match(/(.*?)=(.*)/),
                        i || (i = [o[u], o[u], ""]),
                        "" !== i[1].replace(/\s/g, "")) {
                            if (i[2] = t(i[2] || ""),
                ...
                return function(t, o) {
                    ...
                    if ("tld?" === t)
                        return e();
                    if (o = o || window.location.toString(),
                    !t)
                        return o;
                    if (t = t.toString(),
                    i = o.match(/^mailto:([^\/].+)/))
                        ...
                        if ((i = o.match(/(.*?)\/#\!(.*)/)) && (o = i[1] + i[2]),
                        (i = o.match(/(.*?)#(.*)/)) && (s.hash = i[2],
                        o = i[1]),
                        s.hash && t.match(/^#/))
                            return r(t, s.hash);
                        if ((i = o.match(/(.*?)\?(.*)/)) && (s.query = i[2],
                        o = i[1]),
                        s.query && t.match(/^\?/))
                            return r(t, s.query);
                        if ((i = o.match(/(.*?)\:?\/\/(.*)/)) && (s.protocol = i[1].toLowerCase(),
                        o = i[2]),
                        (i = o.match(/(.*?)(\/.*)/)) && (s.path = i[2],
                        o = i[1]),
                        s.path = (s.path || "").replace(/^([^\/])/, "/$1").replace(/\/$/, ""),
                        t.match(/^[\-0-9]+$/) && (t = t.replace(/^([^\/])/, "/$1")),
                        t.match(/^\//))
                            return n(t, s.path.substring(1));
                        if (i = n("/-1", s.path.substring(1)),
                        i && (i = i.match(/(.*?)\.(.*)/)) && (s.file = i[0],
                        s.filename = i[1],
                        s.fileext = i[2]),
                        (i = o.match(/(.*)\:([0-9]+)$/)) && (s.port = i[2],
                        o = i[1]),
                        (i = o.match(/(.*?)@(.*)/)) && (s.auth = i[1],
                        o = i[2]),
                        s.auth && (i = s.auth.match(/(.*)\:(.*)/),
                        s.user = i ? i[1] : s.auth,
                        s.pass = i ? i[2] : void 0),
                        s.hostname = o.toLowerCase(),
                        "." === t.charAt(0))
                            return n(t, s.hostname);
                        e() && (i = s.hostname.match(e()),
                        i && (s.tld = i[3],
                        s.domain = i[2] ? i[2] + "." + i[3] : void 0,
                        s.sub = i[1] || void 0)),
            ...
            _.info = {
                initPage: function() {
                    var e = document.referrer
                      ...
                      , n = e ? _.url("domain", e) : e
                      , r = location.href
                      , o = r ? _.url("hostname", r) : r
                      , i = r ? _.url("domain", r) : r;
                    this.pageProp = {
                        referrer: e,
                        referrer_host: t,
                        referrer_domain: n,
                ...
                campaignParamsStandard: function(e, t) {
                    ...
                    var n = _.info.campaignParams()
                      ...
                      , o = {};
                    for (var i in n)
                        -1 !== (" " + source_channel_standard + " ").indexOf(" " + i + " ") ? r[e + i] = n[i] : o[t + i] = n[i];
                    return {
                        $utms: r,
                        otherUtms: o
                    }
            ...
            sd.sendState.getSendCall = function(e, t) {
                ++this._receive;
                var n = "_state" + this._receive
                  , r = this;
                this[n] = document.createElement("img"),
                this[n].onload = this[n].onerror = function(e) {
                    r[n].onload = null,
                    r[n].onerror = null,
                    delete r[n],
                    ++r._complete,
                ...
                logger.info(e),
                e = JSON.stringify(e),
                -1 !== sd.para.server_url.indexOf("?") ? this[n].src = sd.para.server_url + "&data=" + encodeURIComponent(_.base64Encode(e)) : this[n].src = sd.para.server_url + "?data=" + encodeURIComponent(_.base64Encode(e))
            }
            ;
            var saNewUser = {
                ...
                checkIsFirstTime: function(e) {
                    "track" === e.type && (this.is_first_visit_time ? (e.properties.$is_first_time = !0,
                ...
                storeInitCheck: function() {
                    if (is_first_visitor) {
                        ...
                        _.cookie.set("sensorsdata_is_new_user", "true", 3600 * t.h + 60 * t.m + t.s + "s"),
                        this.is_first_visit_time = !0
                    } else
                        null === _.cookie.get("sensorsdata_is_new_user") && (this.checkIsAddSign = function(e) {
            ...
            saEvent.checkOption = {
                ...
                str: function(e) {
                    return !!_.isString(e) || (logger.info("请检查参数格式,必须是字符串"),
                    !0)
                },
                properties: function(e) {
                    return _.strip_sa_properties(e),
                    !e || (_.isObject(e) ? !!this.checkPropertiesKey(e) || (logger.info("properties里的key必须是由字符串数字_组成，且不能是系统保留字"),
                    !0) : (logger.info("properties可以没有，但有的话必须是对象"),
                    !0))
                },
                propertiesMust: function(e) {
                    return _.strip_sa_properties(e),
                    void 0 === e || !_.isObject(e) || _.isEmptyObject(e) ? (logger.info("properties必须是对象且有值"),
                    !0) : !!this.checkPropertiesKey(e) || (logger.info("properties里的key必须是由字符串数字_组成，且不能是系统保留字"),
                    !0)
                },
                event: function(e) {
                    return !(!_.isString(e) || !this.regChecks.regName.test(e)) || (logger.info("请检查参数格式,必须是字符串,且eventName必须是字符串_开头,且不能是系统保留字"),
                    !0)
                },
                test_id: "str",
                group_id: "str",
                distinct_id: function(e) {
                    return !(!_.isString(e) || !/^.{1,255}$/.test(e)) || (logger.info("distinct_id必须是不能为空，且小于255位的字符串"),
                    !1)
                }
            },
            saEvent.check = function(e) {
                var t = !0;
                for (var n in e)
                    if (!this.checkOption.check(n, e[n]))
                        return !1;
                return t
            }
            ,
            saEvent.send = function(e, t) {
                ...
                _.extend(n, e),
                error_msg.length > 0 && (n.jssdk_error = error_msg.join("--")),
                _.isObject(e.properties) && !_.isEmptyObject(e.properties) && _.extend(n.properties, e.properties),
                _.isObject(t) && _.extend(n.lib, t),
                e.type && "profile" === e.type.slice(0, 7) || (n.properties = _.extend({}, _.info.properties(), store.getProps(), store.getSessionProps(), _.info.currentProps, n.properties)),
                n.properties.$time && _.isDate(n.properties.$time) ? (n.time = 1 * n.properties.$time,
                delete n.properties.$time) : sd.para.use_client_time && (n.time = 1 * new Date),
                _.searchObjDate(n),
                _.searchObjString(n),
                saNewUser.checkIsAddSign(n),
                saNewUser.checkIsFirstTime(n),
                sd.para.debug_mode === !0 ? (logger.info(n),
                this.debugPath(JSON.stringify(n), t)) : sd.sendState.getSendCall(n, t)
            }
            ,
            saEvent.debugPath = function(e, t) {
                var n = "";
                n = -1 !== sd.para.debug_mode_url.indexOf("?") ? sd.para.debug_mode_url + "&data=" + encodeURIComponent(_.base64Encode(e)) : sd.para.debug_mode_url + "?data=" + encodeURIComponent(_.base64Encode(e)),
                _.ajax({
                    url: n,
                    type: "GET",
                    cors: !0,
            ...
            var store = sd.store = {
                ...
                toState: function(e) {
                    var t = null;
                    null != e && _.isJSONString(e) ? (t = JSON.parse(e),
                    t.distinct_id ? this._state = t : (this.set("distinct_id", _.UUID()),
                    error_msg.push("toStateParseDistinctError"))) : (this.set("distinct_id", _.UUID()),
                ...
                init: function() {
                    navigator.cookieEnabled || (error_msg.push("cookieNotEnable"),
                    _.localStorage.isSupport || error_msg.push("localStorageNotEnable")),
                    this.initSessionState();
                    var e = _.cookie.get(sd.para.cross_subdomain ? "sensorsdata2015jssdkcross" : "sensorsdata2015jssdk");
                    null === e ? (is_first_visitor = !0,
                    just_test_distinctid = 1,
                    this.set("distinct_id", _.UUID())) : (just_test_distinctid = 2,
                    just_test_distinctid_detail = JSON.stringify(e),
              ...
              , commonWays = {
                ...
                allTrack: function() {
                    if (!document || !document.body)
                        return setTimeout(this.allTrack, 1e3),
                        !1;
                    if ("has_init" === sd.allTrack)
                        return !1;
                    ...
                    var e = {
                        getProps: function(e, t) {
                            var n = {};
                            if (n._el_tagname = e,
                            n._el_name = t.getAttribute("name"),
                            n._el_id = t.getAttribute("id"),
                            n._el_classname = "string" == typeof t.className ? t.className : null,
                            n._el_href = t.getAttribute("href"),
                            t.textContent) {
                                var r = _.trim(t.textContent);
                                r && (r = r.replace(/[\r\n]/g, " ").replace(/[ ]+/g, " ").substring(0, 255)),
                                n._el_value = r
                            }
                            return n = _.strip_empty_properties(n),
                            n.$url = location.href,
                        ...
                        clickEvents: function(e) {
                            ...
                            if (-1 !== " button a input ".indexOf(" " + r + " ")) {
                                if ("input" === r) {
                                    if ("button" !== n.getAttribute("type") && "submit" !== n.getAttribute("type"))
                                        return !1;
                                    t._el_value = n.value
                                }
                                _.extend(t, this.getProps(r, n)),
                                "a" === r ? _.trackLink({
                                    event: e
                                }, "_web_event", t) : sd.track("_web_event", t)
                            }
                        }
                    };
                ...
                autoTrack: function(e, t) {
                    ...
                    var n = _.info.campaignParams()
                      , r = {};
                    for (var o in n)
                        -1 !== (" " + source_channel_standard + " ").indexOf(" " + o + " ") ? r["$" + o] = n[o] : r[o] = n[o];
            ...
            _.trackLink = function(e, t, n) {
                ...
                e.event && (o = e.event.target),
                n = n || {},
                !(!o || "object" != typeof o) && (!o.href || /^javascript/.test(o.href) || o.target ? (sd.track(t, n),
                !1) : (e.event && r(e.event),
            ...
            sd.trackLinks = function(e, t, n) {
                return n = n || {},
                !(!e || "object" != typeof e) && (!(!e.href || /^javascript/.test(e.href) || e.target) && void _.addEvent(e, "click", function(r) {
                    function o() {
                        i || (i = !0,
            ...
            sd.appendProfile = function(e, t) {
                saEvent.check({
                    ...
                    _.isString(t) ? e[n] = [t] : _.isArray(t) || (delete e[n],
            ...
            sd.identify = function(e, t) {
                ...
                "undefined" == typeof e ? n ? store.set("first_id", _.UUID()) : store.set("distinct_id", _.UUID()) : saEvent.check({
                    distinct_id: e
                }) ? t === !0 ? n ? store.set("first_id", e) : store.set("distinct_id", e) : n ? store.change("first_id", e) : store.change("distinct_id", e) : logger.info("identify的参数必须是字符串")
            }
            ,
            ...
            sd.login = function(e) {
                if (saEvent.check({
                    ...
                    e !== n && (t ? sd.trackSignup(e, "$SignUp") : (store.set("first_id", n),
            ...
            sd.logout = function(e) {
                var t = store.getFirstId();
                t ? (store.set("first_id", ""),
                e === !0 ? store.set("distinct_id", _.UUID()) : store.set("distinct_id", t)) : logger.info("没有first_id，logout失败")
            }
            ,
            sd.init = function() {
        ...
        !function() {
            var t = window.sensorsDataAnalytic201505;
            "string" == typeof t && (t = window[t],
            null == t || "function" != typeof t && "object" != typeof t || t.track && t.track("_js_sdk_error", {
                _js_sdk_error_msg: e,
                $url: location.href
            }))
        }()
...
, function(e, t) {
    ...
    t.query = function(e) {
        ...
        return t.split("&").filter(function(e) {
            ...
            var t = e.split("=")
              , r = decodeURIComponent(t.shift());
            n[r] = decodeURIComponent(t.join("="))
        }),
        n
    }
    ;
    var n = navigator.userAgent.indexOf("iPhone OS") > 0
      , r = navigator.userAgent.indexOf("Android") > 0;
    t.isInWeChat = navigator.userAgent.indexOf("MicroMessenger") >= 0,
    t.isInAlipay = navigator.userAgent.indexOf("AlipayClient") >= 0;
    ...
    t.API_HOST = {
        ...
        "qatestapi.ofo.so": s || "qa-mastertest.ofo.so",
    ...
    t.ofoAppVersion = o ? o[1] : null,
    t.ofoAppSourceVersion = navigator.userAgent.substring(navigator.userAgent.indexOf("SourceVersion/")).split(" ")[0].split("/")[1],
    t.isLikelyInApp = t.currentEnv === t.ENV.LIKELY_TO_BE_INSIDE_OLD_IOS_APP || t.currentEnv === t.ENV.LIKELY_TO_BE_INSIDE_OLD_ANDROID_APP || t.currentEnv === t.ENV.INSIDE_NEW_IOS_APP || t.currentEnv === t.ENV.INSIDE_NEW_ANDROID_APP,
    t.isInNewApp = t.currentEnv === t.ENV.INSIDE_NEW_IOS_APP || t.currentEnv === t.ENV.INSIDE_NEW_ANDROID_APP,
    t.sourceForApi = t.currentEnv === t.ENV.LIKELY_TO_BE_INSIDE_OLD_IOS_APP || t.currentEnv === t.ENV.INSIDE_NEW_IOS_APP ? 1 : t.currentEnv === t.ENV.LIKELY_TO_BE_INSIDE_OLD_ANDROID_APP || t.currentEnv === t.ENV.INSIDE_NEW_ANDROID_APP ? 2 : t.isInAlipay ? t.isInWeChat ? -3 : -2 : t.isInWeChat ? -1 : 0,
    t.sourceForSa = t.currentEnv === t.ENV.LIKELY_TO_BE_INSIDE_OLD_IOS_APP || t.currentEnv === t.ENV.INSIDE_NEW_IOS_APP ? 1 : t.currentEnv === t.ENV.LIKELY_TO_BE_INSIDE_OLD_ANDROID_APP || t.currentEnv === t.ENV.INSIDE_NEW_ANDROID_APP ? 2 : t.isInAlipay ? t.isInWeChat ? -3 : -2 : t.isInWeChat ? -1 : 0,
    t.ofoAppVersionGte = function(e, n) {
    ...
    t.ofoApp = function(e, n) {
        if (r) {
            ...
            t.isLikelyInApp || setTimeout(function() {
                window.location.href = "https://common.ofo.so/app/?appversion=" + n
            }, 600)
        } else
            t.isInWeChat || (window.location.href = "ofoapp://" + e),
            t.isLikelyInApp || setTimeout(function() {
                window.location.href = "https://common.ofo.so/app/?appversion=" + n
            }, 25)
    }
...
, function(e, t, n) {
    ...
    t.ofoResponseProxy = function(e, t) {
        if ("saClick" !== e) {
            if ("setTitle" === e && !r.isLikelyInApp)
                return void (window.top.document.title = t[0]);
            if (("setTitle" !== e || !r.isLikelyInApp || r.ofoAppVersionGte("1.8.1", 11e3)) && ("shareConfig" !== e || !r.isLikelyInApp || r.ofoAppVersionGte("1.8.4", 11e3))) {
                if ("shareConfig" === e) {
                    if (r.isInWeChat && r.currentEnv === r.ENV.INSIDE_WEBAPP)
                        return void s(r.iframingAncestorWhichIsWebApp, t);
                    if (r.isInWeChat && window.wx)
                        return void s(window, t)
                }
                if ("openExternal" === e && r.currentEnv === r.ENV.INSIDE_NEW_IOS_APP && (e = "toSafari"),
                window.ofoResponse)
                    try {
                    ...
                    n.setAttribute("src", "ofowebviewresponse://" + e + "/" + encodeURI(JSON.stringify(t))),
                    document.documentElement.appendChild(n),
                    setTimeout(function() {
                        return n.parentNode.removeChild(n)
                    })
                } else
                    r.currentEnv === r.ENV.INSIDE_NEW_IOS_APP && window.webkit.messageHandlers.ofo_iOS.postMessage({
                        method: e,
                        params: t
                    })
            }
    ...
    t.handleLink = function(e, t) {
        return r.iframingAncestorWhichIsWebApp ? void r.iframingAncestorWhichIsWebApp.ofoHandleDeepLink(e) : void (r.isLikelyInApp ? (window.location.replace(e),
        r.isInNewApp || setTimeout(function() {
            return window.alert("您可能需要更新至最新版 ofo app 才能使用此功能。")
        }, 1e3)) : "ofoapp://use" === e ? window.location.replace("/newdist/?Journey") : "ofoapp://purchase" === e ? window.location.replace("/newdist/?Purchase") : "ofoapp://bond" === e ? window.location.replace("/newdist/?Identification") : "ofoapp://certify" === e && window.location.replace("/newdist/?Identification"))
    }
}
, function(e, t, n) {
    "use strict";
    var r = n(7)
      ...
      , s = function() {
        ...
        return function(t, n, s) {
            ...
            c.forEach(function(e) {
                e in u && (a.query[e] = u[e])
            });
            var d = {
                Source: o.sourceForSa
            };
            i("_SD", a, d),
            sa.track("_SD$" + t, d)
        }
      ...
      , a = function(e, t, n) {
        return "ofo.so" !== window.location.hostname.substr(window.location.hostname.length - 6) ? void console.log("当前域名不是 ofo.so，已跳过统计发送。") : void s(e, t, n)
    };
    window.addEventListener("error", function(e) {
        "NOT_AN_EXCEPTION" !== e.error && a("JsError", {
            message: e.message,
...
, function(e, t, n) {
    ...
    var r = n(8)
      , o = /^.{16,}$/;
    o.test(window.ofoToken) && (window.localStorage && window.localStorage.setItem("ofo-tokened", window.ofoToken),
    r.set("ofo-tokened", window.ofoToken)),
    e.exports = function() {
        var e, t, n = window;
        try {
            do {
        ...
        return console.log("COOKIE RESULT: " + r.get("ofo-tokened")),
        o.test(t) ? t : window.localStorage && (t = localStorage.getItem("ofo-tokened"),
        o.test(t)) ? t : (t = r.get("ofo-tokened"),
        o.test(t) ? t : null)
    }
}
, function(e, t, n) {
    ...
    !function(t) {
        var n = !1;
        if ("function" == typeof r && r.amd && (r(t),
        n = !0),
        e.exports = t(),
        n = !0,
        !n) {
                ...
                if ("undefined" != typeof document) {
                    ...
                    for (var c = document.cookie ? document.cookie.split("; ") : [], u = /(%[0-9A-Z]{2})+/g, d = 0; d < c.length; d++) {
                        ...
                        try {
                            ...
                            if (p = n.read ? n.read(p, f) : n(p, f) || p.replace(u, decodeURIComponent),
                            this.json)
                                try {
                                    p = JSON.parse(p)
                                } catch (e) {}
...
, function(module, exports) {
    ...
    var actions = "", showResult, addResult = function(e) {
        ...
        showResult = function(e) {
            ...
            t.appendChild(document.createTextNode(e.source)),
            outputs.appendChild(t);
            var n;
            "stack"in e && (n = document.createElement("i"),
            n.appendChild(document.createTextNode(" [stack]")),
            ...
            r.appendChild(document.createTextNode(e.message)),
            outputs.appendChild(r),
    ...
    document.addEventListener("touchend", function(e) {
        if (!showResult) {
            var t = e.changedTouches[0]
              , n = Date.now() - idens[t.identifier];
            actions += n > 1200 ? "L" : n < 400 ? "S" : " ",
            delete idens[t.identifier],
            actions.length > 15 && (actions = actions.substr(5)),
            actions.indexOf("LSLSLS") >= 0 && (actions = "",
            window.confirm("Open debug console?") && openDebugConsole())
        }
    })
}
, function(e, t) {
...
, function(e, t) {
    e.exports = function(e, t) {
        var n, r = "", o = !0;
        console.log(e),
        r = "<div style='padding:15px 20px;background:rgba(0,0,0,.75);color:#fff;border-radius:4px;text-align:center;min-width:160px;'><p data-label='tip-text' style='font-size: 14px;line-height:20px;margin:0;'>" + e + "</p></div>",
        t && (o = !1,
        r = "<div style='padding:15px 20px;background:rgba(0,0,0,.75);color:#fff;border-radius:4px;text-align:center;min-width:160px;'><p data-label='tip-text' style='font-size: 14px;line-height:20px;margin:0;'>" + e + "</p><button data-label='tip-ok'>确定,我知道了</button></div>"),
        (n = document.body.querySelector('[data-label="tip"]')) ? n.querySelector('[data-label="tip-text"]').innerHTML = e : (n = document.createElement("div"),
        n.className = "ofo-iff",
        n.setAttribute("data-label", "tip"),
        document.body.appendChild(n),
        n.setAttribute("style", "position:fixed;width:100%;height:100%;z-index:9999; justify-content:center;align-items:center;display: flex;top:0;opacity:0;padding:0 20px;box-sizing:border-box !important;-webkit-transition: opacity 0.2s linear 0s, height 0s linear 0s;")),
        n.innerHTML = r,
        setTimeout(function() {
            n.style.opacity = 1
        }, 10),
        n.timeoutHandle && clearTimeout(n.timeoutHandle),
        o ? n.timeoutHandle = setTimeout(function() {
            n.style.opacity = 0,
...
, function(e, t, n) {
    "use strict";
    var r, o = n(4), i = n(6), s = function() {
        var e = new XMLHttpRequest;
        e.open("post", "//" + o.API_HOST + "/ofo/wechat/config"),
        e.setRequestHeader("Content-type", "application/x-www-form-urlencoded"),
        e.onload = function() {
            var t = JSON.parse(e.responseText).values.info;
            return t.url !== window.location.href ? void i("WXNonMatch", {
                config: t
            }) : void wx.config({
                debug: !1,
                appId: t.appid,
        ...
        window.location.href !== r && (r = window.location.href,
        s())
    }, c = function(e, t) {
        return function() {
    ...
    window.top === window && o.isInWeChat && (n(13),
    wx.error(function(e) {
        i("WXError", {
            message: e
        })
    ...
    history.pushState = c(history.pushState, a),
    history.replaceState = c(history.replaceState, a),
    setInterval(a, 500))
}
, function(e, t) {
    !function(e, t) {
        ...
        function a(e, t) {
            ...
            "config" == o && "function not exist" == n && (n = "ok"),
            "" == n && (n = "fail")),
            t = o + ":" + n
        }
        function c(e) {
        ...
        function d() {
            0 != P.preVerifyState && (w || y || A.debug || "6.0.2" > I || P.systemType < 0 || x || (x = !0,
            P.appId = A.appId,
            P.initTime = N.initEndTime - N.initStartTime,
            P.preVerifyTime = N.preVerifyEndTime - N.preVerifyStartTime,
            D.getNetworkType({
                isInnerInvoke: !0,
                success: function(e) {
                    var t, n;
        ...
        var g, h, _, m, v, b, w, y, S, k, E, I, x, O, N, P, A, T, C, D;
        if (!e.jWeixin)
            return g = {
            ...
            w = !(!b.match("mac") && !b.match("win")),
            y = -1 != v.indexOf("wxdebugger"),
            S = -1 != v.indexOf("micromessenger"),
            k = -1 != v.indexOf("android"),
            E = -1 != v.indexOf("iphone") || -1 != v.indexOf("ipad"),
            I = function() {
            ...
            D = {
                ...
                ready: function(e) {
                    0 != C.state ? e() : (T._completes.push(e),
                    !S && A.debug && e())
                },
                error: function(e) {
                    "6.0.2" > I || O || (O = !0,
                    -1 == C.state ? e(C.data) : T._fail = e)
                },
...
, function(e, t) {
    ...
    !function() {
        ...
        function t(e, n) {
            ...
            !t.notNeeded(e)) {
                for (var s = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], a = this, c = 0, u = s.length; c < u; c++)
                    a[s[c]] = r(a[s[c]], a);
        ...
        var r = navigator.userAgent.indexOf("Windows Phone") >= 0
          , o = navigator.userAgent.indexOf("Android") > 0 && !r
          , i = /iP(ad|hone|od)/.test(navigator.userAgent) && !r
        ...
        t.prototype.onTouchEnd = function(e) {
            ...
            this.trackingClick = !1,
            this.trackingClickStart = 0,
            a && (u = e.changedTouches[0],
            d = document.elementFromPoint(u.pageX - window.pageXOffset, u.pageY - window.pageYOffset) || d,
            d.fastClickScrollParent = this.targetElement.fastClickScrollParent),
            r = d.tagName.toLowerCase(),
            "label" === r) {
                ...
                return e.timeStamp - n > 100 || i && window.top !== window && "input" === r ? (this.targetElement = null,
                !1) : (this.focus(d),
                this.sendClick(d, e),
                i && "select" === r || (this.targetElement = null,
                e.preventDefault()),
                !1);
            return !(!i || s || (c = d.fastClickScrollParent,
        ...
        t.prototype.destroy = function() {
            var e = this.layer;
            o && (e.removeEventListener("mouseover", this.onMouse, !0),
        ...
        t.notNeeded = function(e) {
            ...
            if (c && (r = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/),
            ...
            return "none" === e.style.msTouchAction || "manipulation" === e.style.touchAction || (i = +(/Firefox\/([0-9]+)/.exec(navigator.userAgent) || [, 0])[1],
            !!(i >= 27 && (t = document.querySelector("meta[name=viewport]"),
        ...
        "function" == typeof n && "object" == typeof n.amd && n.amd ? n(function() {
            return t
        }) : "undefined" != typeof e && e.exports ? (e.exports = t.attach,
