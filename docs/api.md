...
<dl>
<dt><a href="#checkOpen">checkOpen(cb)</a></dt>
<dd><p>检查iframe方式是否成功唤醒</p></dd>
</dl>
...
| callback.onStart | [<code>wakeupCallback</code>](#wakeupCallback) | <p>-</p> |
| callback.onEnd | [<code>wakeupCallback</code>](#wakeupCallback) | <p>-</p> |
| callback.onSuccess | [<code>wakeupCallback</code>](#wakeupCallback) | <p>该回调在QQ、UC等iframe打开时会以为弹窗而导致失效</p> |
| callback.onFail | [<code>wakeupCallback</code>](#wakeupCallback) | <p>参考onSuccess</p> |
| callback.onWeChat | [<code>wakeupCallback</code>](#wakeupCallback) | <p>当前环境是微信</p> |
...
| callback.onStart | [<code>wakeupCallback</code>](#wakeupCallback) | <p>-</p> |
| callback.onEnd | [<code>wakeupCallback</code>](#wakeupCallback) | <p>-</p> |
| callback.onSuccess | [<code>wakeupCallback</code>](#wakeupCallback) | <p>该回调在QQ、UC等iframe打开时会因为弹窗而导致失效</p> |
| callback.onFail | [<code>wakeupCallback</code>](#wakeupCallback) | <p>参考onSuccess</p> |
| callback.onWeChat | [<code>wakeupCallback</code>](#wakeupCallback) | <p>当前环境是微信</p> |
...
* [feOpenWeb](#feOpenWeb)
    * [new feOpenWeb(schema, intentData, deepLink，, downloadUrl, appFlag, callback)](#new_feOpenWeb_new)
    * [.open(urls, isFromAutoOpen)](#feOpenWeb+open)
...
<a name="feOpenWeb+open"></a>

### feOpenWeb.open(urls, isFromAutoOpen)
<p>手动执行唤醒</p>

**Kind**: instance method of [<code>feOpenWeb</code>](#feOpenWeb)  
**Implements**: [<code>open</code>](#feOpen+open)  
...
| urls.intent | <code>string</code> |  |
| urls.schema | <code>string</code> |  |
| isFromAutoOpen | <code>boolean</code> | <p>是否来自自动唤醒，该模式不允许使用deep link</p> |
...
* [feOpen](#feOpen)
    ...
    * [.download(url)](#feOpen+download)
    * [.start(open)](#feOpen+start)
    * [.open(urls, isFromAutoOpen)](#feOpen+open)
...
### feOpen.open(urls, isFromAutoOpen)
<p>手动执行唤醒</p>
...
* [feOpenWeb](#feOpenWeb)
    * [new feOpenWeb(schema, intentData, deepLink，, downloadUrl, appFlag, callback)](#new_feOpenWeb_new)
    * [.open(urls)](#feOpenWeb+open)
    * [.openAuto()](#feOpenWeb+openAuto)
...
<a name="feOpenWeb+openAuto"></a>

### feOpenWeb.openAuto()
<p>自动执行唤醒，排除使用deep link方式，且不引导下载</p>

**Kind**: instance method of [<code>feOpenWeb</code>](#feOpenWeb)  
**Implements**: [<code>openAuto</code>](#feOpen+openAuto)  
<a name="feOpen"></a>
...
* [feOpen](#feOpen)
    * [new feOpen()](#new_feOpen_new)
    * [.config](#feOpen+config)
    * [._openByIframe()](#feOpen+_openByIframe)
    * [.download(url)](#feOpen+download)
    * [.start(open)](#feOpen+start)
    * [.open(urls)](#feOpen+open)
    * [.openAuto()](#feOpen+openAuto)
...
<a name="feOpen+_openByIframe"></a>

### feOpen._openByIframe()
<p>使用iframe方式打开APP</p>
...
| callback.onSuccess | [<code>wakeupCallback</code>](#wakeupCallback) | <p>该回调在QQ、UC等iframe打开时会因为弹窗而导致失效</p> |
| callback.onFail | [<code>wakeupCallback</code>](#wakeupCallback) | <p>参考onSuccess</p> |
| callback.onNotSupport | [<code>wakeupCallback</code>](#wakeupCallback) | <p>当前环境不支持</p> |
...
| callback.onSuccess | [<code>wakeupCallback</code>](#wakeupCallback) | <p>该回调在QQ、UC等iframe打开时会以为弹窗而导致失效</p> |
| callback.onFail | [<code>wakeupCallback</code>](#wakeupCallback) | <p>参考onSuccess</p> |
| callback.onNotSupport | [<code>wakeupCallback</code>](#wakeupCallback) | <p>function(action) 应用内置浏览器事件，不支持唤起，action='wakeup'/'download'，分别表示唤醒或下载</p> |
